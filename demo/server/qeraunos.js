...
Qeraunos.prototype.setSize = function (capacity) {
    ...
    setInterval(function () { return _this.qeraunosCache = new QeraunosCache(capacity); }, 60 * 60 * 1000);
};
...
// Qeraunos.prototype.delete = async function (req: Request, res: Response, next: NextFunction) {
//   if (this.qeraunosCache) {
//     this.qeraunosCache = new QeraunosCache(1000);
//   }
// }
