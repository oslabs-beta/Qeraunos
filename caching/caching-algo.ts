...
function LfuNode(this: any, key: string, value: object) {
  this.next = null;
  this.prev = null;
  this.key = key;
  this.value = value;
...
function LfuDLL(freqCount: number) {
...
LfuCache.prototype.updateNode = function (node: NodeType): void {
  ...
  if (!this.frequency[node.freqCount])
    this.frequency[node.freqCount] = new (LfuDLL as any)(node.freqCount);
